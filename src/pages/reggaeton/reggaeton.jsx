    ...
    <section className="regga col-sm-12 col-md-12 col-lg-12 py-4">
      <header className="container py-2 d-flex align-items-center justify-content-between">
        <div class="col-sm-12 col-md-12 col-lg-12 px-5">
          <Link to="/">
            <img src={LogoRegga} width="100" alt="ODA_Logo" />
          </Link>
          <article className="text-white text-center">
            <h2 className="tituloW">Reggaeton</h2>
            <p className="py-3">
              Este es un género que tiene sus raíces en el Reggae, cuando los
              obreros afro panameños que construían el canal de panamá seguían
              la cultura Rastafarí, escuchan cintas de reggae y las traducían a
              español.
            </p>
